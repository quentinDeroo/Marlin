...
void lv_draw_dialog(uint8_t type) {
  ...
  style_btn_rel.body.main_color   = lv_color_hex3(0x000);
  style_btn_rel.body.grad_color   = lv_color_hex3(0x000);
  style_btn_rel.body.shadow.width = 4;
  style_btn_rel.body.shadow.type  = LV_SHADOW_BOTTOM;
  style_btn_rel.body.radius       = 3;//LV_RADIUS_CIRCLE;
  ...
  style_btn_pr.body.main_color   = lv_color_hex3(0xFFF);
  style_btn_pr.body.grad_color   = lv_color_hex3(0xFFF);
